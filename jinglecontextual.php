...
// This is where the action happens
    public function widget( $args, $instance ) {
        ...
        if (availwidth>(<?php echo $mwidth;?>+margin)*2){
            ...
            np = Math.floor(availwidth/(<?php echo $mwidth;?>+margin));
            document.getElementById('jingle_contextual_<?php echo $this->id;?>').style.maxWidth = availwidth+'px';
            jscroll_direction ="up";
            product_width = availwidth/np;
            product_height = product_width*2;
            jheight = product_height;
            image_width = product_width-margin;
            image_height = image_width*4/3;
            img_css = "a img {max-width:"+image_width+"px;width:100%;max-height:none;}";
        } else {
            ...
            jscroll_direction ="up";
            product_width = availwidth;
            product_height = product_width*4/3+80;
            jheight = product_height*<?php echo $nproducts;?>;
            image_width = product_width;
            image_height = image_width*4/3;
            img_css = "a img {max-width:100%;width:100%;max-height:none;}";
        }
